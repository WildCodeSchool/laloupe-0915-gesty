...
use SchoolCalendar\Component\Scheduler\Period;
use SchoolCalendar\Component\Scheduler\PeriodInterface;
use SchoolCalendar\Component\Scheduler\PeriodIterator;

/**
 * Class PeriodIteratorTest
 * @coversDefaultClass \SchoolCalendar\Component\Scheduler\PeriodIterator
 */
class PeriodIteratorTest extends \PHPUnit_Framework_TestCase
{
     ...
     *  And is valid
     *
     * @uses \SchoolCalendar\Component\Scheduler\PeriodIterator::__construct
     * @covers ::next
     * @covers ::key
     * @covers ::current
     * @covers ::valid
     ...
     *
     * @covers ::__construct
     * @uses \SchoolCalendar\Component\Scheduler\PeriodIterator::count
     */

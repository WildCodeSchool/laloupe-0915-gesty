...
class Ical
{
    ...
    {
        if (!$filename) {
            throw new IcalException('', IcalException::E_NOFILENAME);
        }
        ...
        try  {
            ...
            throw new IcalException($filename, IcalException::E_FILENOTFOUND);
        }
        ...
        if (stristr($lines[0], 'BEGIN:VCALENDAR') === false) {
            throw new IcalException($filename, IcalException::E_INVALIDFILE);
        }
